...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Gadget Feature</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class GadgetFeatureImpl extends EObjectImpl implements GadgetFeature {
	/**
	...
	protected EClass eStaticClass() {
		return OpenSocialPackage.Literals.GADGET_FEATURE;
	}
	...
	public void setFeature(String newFeature) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenSocialPackage.GADGET_FEATURE__FEATURE, oldFeature, feature));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OpenSocialPackage.GADGET_FEATURE__PARAM:
